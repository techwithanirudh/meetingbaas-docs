...
3. You should implement a monitoring strategy using this routeto detect these failures and prompt users to reconnect their calendars
...
_A. User's credentials are expired_
...
_B. Your app's credentials are expired_
