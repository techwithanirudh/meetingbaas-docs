...
description: Learn how to set up calendar integration with Meeting BaaS
icon: Calendar
---

import { Callout } from "@/components/fumadocs/callout";
import { Card } from "@/components/fumadocs/card";
import { Step, Steps } from "@/components/fumadocs/steps";
...
First, you'll need to create OAuth credentials for the calendar provider you want to integrate with. This involves setting up a project in the provider's developer console and configuring OAuth consent.
...
6. Add the following scopes:
   ...
   - `https://www.googleapis.com/auth/calendar.events` - Required if you need to modify calendar events
