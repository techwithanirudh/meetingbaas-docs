...
```
config/
├── personas/                 # Directory containing all persona definitions
│   ├── baas_onboarder/      # Example persona
│   │   ├── README.md        # Core persona definition
│   │   ├── Content.md       # Additional context
│   │   └── Rules.md         # Behavior rules
├── persona_types.py         # Data structures for personas
├── persona_utils.py         # Utility functions for persona management
└── migrate_personas.py      # Migration tool for persona updates
```
