...
To run any bot locally, you'll need an ngrok authtoken.
You can get one directly for free by signing up on the ngrok [website](https://dashboard.ngrok.com/signup).

Once you have your token, add it to your `.env` file or set it as an environment variable:
